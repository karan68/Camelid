...
| **Runnable/experimental lane** | F32, F16, Q8_0, Q4_0, Q3_K, Q4_K, Q5_K, Q6_K, IQ4_XS (for the covered architectures) | The engine runs the file in a clearly-marked experimental lane — every reply flagged unverified, **no parity claim** (`src/runnable/admit.rs`). |
