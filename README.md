...
> **Current public posture:** Camelid achieves 1:1 parity with llama.cpp for four exact GGUF rows within a bounded published validation envelope: TinyLlama at the current validated gate, Llama 3.2 1B/3B Q8_0 through checked bounded 512/1024/2048-context packs, and Llama 3 8B Q8_0 through checked bounded 512/1024/2048-context packs on current head `9f8588bb4a4e`. The 8B 1024/2048 evidence lives at `qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260508T122749Z-head-9f8588bb4a4e/manifest.json` and matched prompt tokens, generated tokens, and generated text for `CMLD-102`/`CMLD-204`. These are exact-row bounded-pack claims only; wider model-native context, production throughput, portability, arbitrary templates, and broad-family support remain outside the claim.
...
- **Four exact Q8_0 rows are public and evidence-backed.** TinyLlama remains the full current gate; Llama 3.2 1B, Llama 3.2 3B, and Llama 3 8B have checked bounded 512/1024/2048-context support for their exact Q8_0 rows on current `main`.
...
The WebUI surface stays intentionally readiness-first: simple, local-first, and aligned with the same exact support contract described by the runtime, API, and docs. It is not a broad model-family or arbitrary-GGUF support claim.
...
- The next major 8B support gaps are model-native/larger context beyond the checked 512/1024/2048 packs, arbitrary templates, production throughput, portability, and repeated durability evidence.
