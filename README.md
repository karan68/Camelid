...
Fresh reopened-lane API-only smoke: `qa/evidence-bundles/four-row-api-only-20260504T230722Z-head-13a465608fbf/manifest.json` records passing exact-row `/api/models/load`, `/v1/models`, `/api/capabilities`, `/v1/completions`, and `/v1/chat/completions` checks for TinyLlama, Llama 3.2 1B, Llama 3.2 3B, and Llama 3 8B Q8_0. This is not full parity evidence and does not close the 8B 512-context blocker.
