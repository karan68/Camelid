...
- **The context ladder is explicit.** The four supported Llama/TinyLlama rows have checked bounded 512-context evidence; Llama 3.2 1B/3B and Llama 3 8B also have checked 1024 and 2048 packs. Mixtral has no promoted context bucket; only bounded one-token backend MoE runtime evidence is retained.
