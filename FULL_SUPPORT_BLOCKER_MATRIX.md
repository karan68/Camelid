...
- Current public worktree: based on `713c744 Align Llama support contract guardrails`; 8B promotion is being reapplied with the guardrails preserved.
