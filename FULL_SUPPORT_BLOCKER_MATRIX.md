...
- A reopened-lane API-only smoke summary now lives under `qa/evidence-bundles/four-row-api-only-20260504T230722Z-head-13a465608fbf/`. It refreshes exact-row API load/models/capabilities/completions/chat evidence only; it does not close frontend, parity, or performance blockers.
