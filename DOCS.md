...
- [`NVFP4_FORMAT.md`](docs/architecture/NVFP4_FORMAT.md) — NVFP4 weight-format spec + BASALT pilot findings (format spec, not a support claim; gemma-4-E4B pilot only, Windows-only)
