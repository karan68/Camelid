...
- `scripts/check-forward-trace-invariants.mjs` validates the new KV trace shape/index/finite-number invariants.

Local validation:

- `./scripts/with-rustup-cargo.sh test -q single_token_forward_diagnostics_follow_llama_stage_order --lib`
