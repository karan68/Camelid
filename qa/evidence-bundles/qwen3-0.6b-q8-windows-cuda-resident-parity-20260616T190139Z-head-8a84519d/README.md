# Qwen3 0.6B Q8_0 — Windows CUDA GPU-resident ChatML parity bundle
...
`all_pass = true` — the GPU-resident CUDA decode is token-AND-text-identical to the llama.cpp comparator at [1,5,50] generated tokens for: default 3 (capital-of-France, primary-color, say-hello)
...
- `qwen3-0.6b-windows-cuda-resident-parity.json`
- `qwen3-0.6b-windows-cpu-reference-parity.json`
- `capabilities.json`
