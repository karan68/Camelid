...
expansion. `manifest.json` now pins the immutable Hugging Face revision containing each
recorded LFS object. All three GGUFs parse, admit, and execute bounded raw generation in
Camelid.
