...
| Mistral-7B-Instruct-v0.3.Q8_0.gguf | `mistral-7b-v0.3-q8-broader-50tok-ubuntu-20260509T000633Z-head-d330e97ae992/`, `mistral-7b-v0.3-q8-context-4096-8192-ubuntu-20260509T005229Z-head-9e3c64f2cfab/`, and `mistral-7b-v0.3-q8-support-promotion-20260605T090914Z-head-d7b1699/`. | No blocker for exact-row smoke support; broader Mistral-family support, neighboring rows, other quants, production throughput, portability, and full support remain unclaimed. |
