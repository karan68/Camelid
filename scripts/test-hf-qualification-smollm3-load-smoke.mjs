...
await assert.rejects(
  inspectExactArtifactIdentity(resolve('C:\\qualification\\artifact-link.gguf'), {
...
for (const [description, mutator, fragment] of [
  ...
  ['path leak', (value) => { value.provenance.private_note = 'C:\\Users\\private\\model.gguf' }, 'absolute local path'],
