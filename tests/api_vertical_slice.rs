...
async fn capabilities_report_support_contract_and_planned_lanes() {
    ...
    assert_eq!(
        ...
        "short_api_webui_smoke_with_broader_50_token_plus_checked_512_context_pack_only"
    );
    ...
    assert!(
        llama3_evidence.contains("1024/2048 remain red until fresh current-head PASS artifacts")
    );
