...
| 2.0 (new) | **GQA QKV decode parallelization** (`inference.rs:13942` serial else-branch) | decode +15–20% | S | none (rows independent, per-row order unchanged) | pending — new opener from P0.4 census |
