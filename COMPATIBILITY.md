...
- **Missing gates:** performance/memory architecture work for KV/cache and attention behavior, Q8 matmul/output-projection hot paths, dense/f32 materialization avoidance, chunked/streamed long-context prefill, per-layer timing/RSS-peak instrumentation, stronger performance evidence, portable packaging evidence, and broader chat-template coverage
