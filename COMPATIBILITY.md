...
| Llama 3.2 1B Instruct Q8_0 | Supported exact-row smoke | Exact-row load, compact/broader parity, API smoke, frontend smoke, the first bounded 512-context pack, the bounded compact chat-template-shapes pack, and the bounded unique-chat perf/RSS envelope are supported for this exact row only. | Normalize broader/larger context, arbitrary/Jinja template behavior beyond the checked compact pack, production throughput, portability, and durable bundle evidence to the TinyLlama bar before any broader/full-support claim. |
...
- **Validated now:** metadata, tokenizer path, tensor load, compact parity, broader prompt-pack parity, the first bounded 512-context pack, the bounded compact chat-template-shapes pack, the bounded unique-chat perf/RSS envelope, `/api/models/load`, `/v1/completions`, `/v1/chat/completions`, and frontend smoke are validated for the exact 1B Instruct Q8_0 row
- **Missing gates:** broader/larger context beyond the checked 512 pack, arbitrary/Jinja template behavior beyond the checked compact pack, production throughput evidence, and portable packaging
...
For **Llama 3.2 1B** specifically, the committed carry-forward row bundle at `qa/evidence-bundles/four-row-public-20260503T024327Z/llama32_1b_instruct_q8_0.bundle.json`, the current-head row manifest at `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama32_1b_instruct_q8_0/manifest.json`, the four-row context bundle at `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json`, the compact template-shapes bundle at `qa/evidence-bundles/llama32-1b-3b-chat-template-shapes-20260505T060036Z-head-e9f28572e090/manifest.json`, and the unique-chat perf/RSS bundle at `qa/evidence-bundles/llama32-1b-3b-unique-chat-perf-rss-20260505T061644Z-head-e9f28572e090/manifest.json` are the durable citation anchors for the exact-row smoke, first bounded 512-context boundary, bounded compact template-shape boundary, and bounded memory/perf envelope. Larger context, arbitrary/Jinja template behavior, production throughput, and portability reruns remain exact-row follow-up work.
