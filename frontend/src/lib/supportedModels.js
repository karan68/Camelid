...
export const SUPPORTED_MODELS = [
  ...
  // Phase 2 exact-row expansion. These rows are downloadable candidates; the
  // live compatibility contract remains authoritative for Supported vs Hold.
  { catalog_id: 'lfm2_5_1_2b_instruct_q8_0', name: 'LFM2.5 1.2B Instruct', repo_id: 'LiquidAI/LFM2.5-1.2B-Instruct-GGUF', filename: 'LFM2.5-1.2B-Instruct-Q8_0.gguf', size_bytes: 1246253888, quant: 'Q8_0', blurb: 'Compact Liquid AI instruct model; exact-row qualification candidate.' },
  ...
  { catalog_id: 'gemma3_270m_it_q8_0', name: 'Gemma 3 270M-It', repo_id: 'unsloth/gemma-3-270m-it-GGUF', filename: 'gemma-3-270m-it-Q8_0.gguf', size_bytes: 291546144, quant: 'Q8_0', blurb: 'Tiny Gemma instruct model; exact-row qualification candidate.' },
  { catalog_id: 'gemma3_4b_it_q8_0', name: 'Gemma 3 4B-It', repo_id: 'ggml-org/gemma-3-4b-it-GGUF', filename: 'gemma-3-4b-it-Q8_0.gguf', size_bytes: 4130226336, quant: 'Q8_0', blurb: 'Capable Gemma text model; currently held on parity.' },
  ...
  { catalog_id: 'mistral_7b_instruct_v0_2_q8_0', name: 'Mistral 7B Instruct v0.2', repo_id: 'TheBloke/Mistral-7B-Instruct-v0.2-GGUF', filename: 'mistral-7b-instruct-v0.2.Q8_0.gguf', size_bytes: 7695857952, quant: 'Q8_0', blurb: 'Classic Mistral instruct row for chat and coding.' },
  ...
  { catalog_id: 'qwen2_5_coder_1_5b_instruct_q8_0', name: 'Qwen2.5 Coder 1.5B Instruct', repo_id: 'Qwen/Qwen2.5-Coder-1.5B-Instruct-GGUF', filename: 'qwen2.5-coder-1.5b-instruct-q8_0.gguf', size_bytes: 1894532160, quant: 'Q8_0', blurb: 'Compact code-focused Qwen row; exact-row qualification candidate.' },
  { catalog_id: 'qwen3_5_0_8b_q8_0', name: 'Qwen3.5 0.8B', repo_id: 'unsloth/Qwen3.5-0.8B-GGUF', filename: 'Qwen3.5-0.8B-Q8_0.gguf', size_bytes: 811843840, quant: 'Q8_0', blurb: 'Small hybrid Qwen3.5 row; exact-row qualification candidate.' },
  { catalog_id: 'qwen3_5_2b_q8_0', name: 'Qwen3.5 2B', repo_id: 'unsloth/Qwen3.5-2B-GGUF', filename: 'Qwen3.5-2B-Q8_0.gguf', size_bytes: 2012012800, quant: 'Q8_0', blurb: 'Compact hybrid Qwen3.5 row; exact-row qualification candidate.' },
  ...
  { catalog_id: 'deepseek_r1_distill_llama_8b_q8_0', name: 'DeepSeek R1 Distill Llama 8B', repo_id: 'unsloth/DeepSeek-R1-Distill-Llama-8B-GGUF', filename: 'DeepSeek-R1-Distill-Llama-8B-Q8_0.gguf', size_bytes: 8540773088, quant: 'Q8_0', blurb: 'Llama-based DeepSeek reasoning distill; exact-row qualification candidate.' },
  { catalog_id: 'phi3_mini_4k_instruct_q8_0', name: 'Phi-3 Mini 4K Instruct', repo_id: 'bartowski/Phi-3-mini-4k-instruct-GGUF', filename: 'Phi-3-mini-4k-instruct-Q8_0.gguf', size_bytes: 4061221376, quant: 'Q8_0', blurb: 'Compact Microsoft Phi-3 row; currently held on incremental-decode parity.' },
  ...
  { catalog_id: 'gemma2_9b_it_q8_0', name: 'Gemma 2 9B-It', repo_id: 'BenevolenceMessiah/gemma-2-9b-it-Q8_0-GGUF', filename: 'gemma-2-9b-it-q8_0.gguf', size_bytes: 9827149312, quant: 'Q8_0', blurb: 'Large Gemma 2 instruct row; exact-row qualification candidate.' },
