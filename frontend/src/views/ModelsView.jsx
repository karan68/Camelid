              ...
              return (
                <article key={target.id} className="model-card models-model-card">
                  ...
                  <div className="models-card-tags">
                    ...
                    {target.id === 'llama3_8b_instruct_q8_0' && <div className="pin-badge warm">8B 1024/2048 remain red pending fresh current-head PASS + docs/API/frontend alignment</div>}
