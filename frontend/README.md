...
- exposes the stateless `/v1/responses` text/tool/stream subset in the API workbench under the same exact-row runtime gate; stateful chaining, hosted tools, and multimodal input remain guarded by the live `openai_responses` conformance row
