...
- **Llama 3 8B Instruct Q8_0:** exact-row API/WebUI smoke, clean-main timing/RSS smoke, broader 50-token parity, the bounded 512-context pack, compact chat-template-shapes pack, and measurement-only lazy-Q8 hot-path cost probe are represented as bounded exact-row wins. The 1024/2048 buckets remain red until fresh PASS artifacts and synchronized docs/API/frontend promotion land together; they are not model-native/larger-context, broad 8B/Llama, production-throughput, or portability support.
