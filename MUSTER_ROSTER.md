...
1. **IQ4_XS docs drift:** `llama3_2_1b_instruct_iq4_xs` (`supported_exact_row_smoke`, PR #455, this head) is present in the contract + ledger but absent from the README supported-models table and the COMPATIBILITY.md at-a-glance table; README's quant-tier table (README.md:200-203) does not name IQ4_XS at all. Pre-existing on `main`, not introduced by MUSTER.
