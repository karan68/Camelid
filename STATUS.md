...
- The current backend pivot is performance/memory architecture, not another 8B long-context promotion attempt: `qa/validation-notes/2026-05-05-prefill-chunk-runtime.md` records the local chunked-prefill/Q8-read-reuse runtime slice and local fmt/clippy/test/release-build gates. This is code evidence only until row-specific Ubuntu timing/parity artifacts exist.
