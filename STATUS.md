...
- Mistral 7B Instruct v0.3 Q8_0 remains an active validation target only: Ubuntu load/serve evidence exists, but exact tokenizer/template references plus 1-token generation parity evidence are still the blocker before any support-promotion evidence anchor can be cited.
