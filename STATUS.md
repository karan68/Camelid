...
Executive summary: Camelid has full API + frontend end-to-end validation for the exact Llama 3.2 1B, Llama 3.2 3B, and Llama 3 8B Instruct Q8_0 rows, refreshed on the reopened Ubuntu validation lane. The previous 3B JSON-shaped broader prompt-pack blocker is resolved, the 8B broader three-prompt 50-token rerun passed, and the exact Llama 3.2 1B/3B/8B rows have bounded 512/1024/2048-context packs green where listed. The fresh 8B 1024/2048 source-head bundle at `qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260508T040523Z-head-e203d3cf3ea5/manifest.json` passed at source head `e203d3cf3ea5`; older 8B 1024/2048 bundles remain historical for their source heads. Llama 3.2 1B/3B bounded compact chat-template-shapes and bounded unique-chat perf/RSS envelopes have passing public summaries, and compact 8B chat-template-shapes also has a passing public summary. The public support boundary moved only for those exact rows and only for the validated local-chat/parity envelopes; broad Llama-family support, model-native/larger contexts beyond the checked packs, arbitrary template execution, and portability remain outside the support claim.
...
- **8B promotion:** Llama 3 8B Instruct Q8_0 has end-to-end bounded generation parity artifacts for compact parity, a three-prompt 50-token Ubuntu parity run, the bounded compact chat-template-shapes pack, API/frontend smoke, bounded-memory evidence, and checked 512/1024/2048-context packs for the exact tracked Q8_0 GGUF. The fresh 1024/2048 bounded prompt-pack pass is published at `qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260508T040523Z-head-e203d3cf3ea5/manifest.json`.
...
- `qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260508T040523Z-head-e203d3cf3ea5/manifest.json` plus `SHA256SUMS` is fresh 8B 1024/2048 bounded-pack PASS evidence for source head `e203d3cf3ea5`; it matched prompt tokens, generated token IDs, and generated text for `CMLD-102` and `CMLD-204`.
...
- Runtime/API alignment is now explicit: `/api/capabilities` exposes 1024/2048 as promoted for the exact Llama 3.2 1B/3B/8B rows where fresh row-specific PASS artifacts exist.
...
- The current 8B context support truth for this exact row includes checked 512/1024/2048 bounded packs. The 1024/2048 pass at `e203d3cf3ea5` matched the bounded prompt packs exactly and is published at `qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260508T040523Z-head-e203d3cf3ea5/manifest.json`; this is exact-row bounded-pack support, not model-native or broad-family promotion.
