...
- [ ] Any 1B / 3B / 8B wording stays aligned with `COMPATIBILITY.md`, `docs/reference/STATUS.md`, and `/api/capabilities`, including bounded-pack caveats for 8B broader 50-token, 512-context, compact template-shapes, and measurement-only lazy-Q8 hot-path evidence
