...
Executive summary: Camelid now has the TinyLlama supported gate plus exact Llama 3.2 1B/3B and Llama 3 8B Q8_0 rows through checked bounded 2048-context packs on current `main` at `9f8588bb4a4e`. The current 8B 1024/2048 PASS bundle is `qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260508T122749Z-head-9f8588bb4a4e/manifest.json`; older 8B 1024/2048 source-head bundles remain historical. Broader/full 8B support remains gated on model-native/larger context beyond checked packs, arbitrary templates, production throughput, portability, and repeated durability evidence.
...
- **Supported generation gates:** TinyLlama 1.1B Chat Q8_0 remains supported; exact Llama 3.2 1B/3B and Llama 3 8B rows are supported through checked bounded 512/1024/2048-context packs on current `main`.
...
Near-term objective: preserve the supported TinyLlama gate and exact Llama 3.2 1B/3B/8B bounded-2048 lanes; do not widen to model-native/larger context beyond checked packs, arbitrary templates, production throughput, portability, or adjacent rows without new evidence.
...
| Llama 3 8B Instruct Q8_0 exact-row smoke | Complete / narrow support through checked 2048 bounded pack | Compact prompt-token/1-token/5-token/50-token parity, the three-prompt 50-token pack, API smoke, frontend smoke, bounded memory evidence, checked bounded 512/1024/2048-context packs, and the compact chat-template-shapes pack support this exact 8B Q8_0 row only. |
