...
- Close the remaining active-validation set as exact-row lanes, never as family-wide claims: Mixtral 8x7B Instruct v0.1 Q8_0 and the two distributed Gemma 4 rows.
