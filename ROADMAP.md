...
Executive summary: Camelid now has the TinyLlama supported gate plus exact Llama 3.2 1B/3B Q8_0 rows through bounded 2048-context packs on current `main`; Llama 3 8B Q8_0 is promoted only through its bounded 512-context pack. The 8B 1024/2048 PASS bundle at `9f8588bb4a4e` is source-head history after later source/API changes; 8B 1024/2048 remain red pending fresh current-head PASS artifacts plus docs/API/frontend alignment. Broader/full 8B support remains gated on model-native/larger context, arbitrary templates, production throughput, portability, and repeated durability evidence.
