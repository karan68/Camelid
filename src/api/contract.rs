...
pub(super) const API_CONFORMANCE_CASES: &[ApiConformanceCase] = &[
    ...
    ApiConformanceCase {
        ...
        notes: "POST /v1/chat/completions supports non-streaming and SSE streaming for loaded supported dense GGUF models, including stateless function-tool round trips on tool-capable rows.",
        routes: &[post("/v1/chat/completions")],
        supported_modes: &["nonstreaming", "streaming", "function_tool_roundtrip"],
        unsupported_modes: &["multimodal_input"],
    },
    ApiConformanceCase {
        id: "openai_responses",
